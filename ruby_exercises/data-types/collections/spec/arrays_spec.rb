...
RSpec.describe 'Arrays' do
  ...
  it 'test 1' do
    # in the line below, create an array wxith the numbers 1 through 5
    nums = [1,2,3,4,5]
  ...
  it 'test 6' do
    karaoke = ["Shake xit Off", "Dancing Queen", "Bohemian Rhapsody"]
  ...
  it 'test 14' do
    furnxiture = ["couch", "bed", "table"]
    # Call a method on the furnxiture variable to add the element
    # "dresser" in between the elements "couch" and "bed"
    new_furnxiture = furnxiture.insert(1, "dresser")
    expect(new_furnxiture).to eq(["couch", "dresser", "bed", "table"])
  end
  ...
  it 'test 16' do
    ...
    # wxith the elements in the opposxite order
  ...
  it 'test 17' do
    ...
    # This test will fail wxith expecting roll to be a FixNum if the
